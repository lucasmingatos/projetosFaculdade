 ...
 * @author lucas
 */
public class FormPesquisarAcessorios extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormPesquisarAcessorios
     */
    public FormPesquisarAcessorios() {
        initComponents();
    ...
    private void txtPesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisarKeyReleased
        ...
        List<Acessorios> lista = null;
        String chave = txtPesquisar.getText();

        if (rdbId.isSelected() && !chave.isEmpty()){
            lista = new AcessoriosDAO().pesquisarPorId(chave);
        }else if (rdbNome.isSelected()){
            lista = new AcessoriosDAO().pesquisarPorNome(chave);
        }
    ...
    private void tabResultadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabResultadosMouseClicked
        ...
        /*if (evt.getClickCount() == 2){
            ...
            Acessorios z = new Acessorios (
                Integer.parseInt(tabResultados.getValueAt(linha, 0).toString()),
                tabResultados.getValueAt(linha, 1).toString()
            );

            FormCadastrarAcessorios b = new FormCadastrarAcessorios(z);
            getDesktopPane().add(b);
            b.setVisible(true);
    ...
    private void configurarFormulario() {
        this.setTitle("Pesquisar Acessorio Esportivo");
    ...
    private void preencherTabela(List<Acessorios> lista) {
        if (lista != null) {
            if (lista.size() > 0) {
                configurarTabela();
