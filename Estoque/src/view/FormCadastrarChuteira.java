 ...
 * @author lucas
 */
public class FormCadastrarChuteira extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormCadastrarChuteira
     */
    public FormCadastrarChuteira() {
        initComponents();
        configurarFormulario();
    }
    
    public FormCadastrarChuteira(Chuteira chu){
        this();
        txtId.setText(Integer.toString(chu.getId()));
        txtNome.setText(chu.getNome());
        txtCor.setText(chu.getCor());
        txtQuantidade.setText(Integer.toString(chu.getQuantidade()));
        txtPreco.setText(Double.toString(chu.getPreco()));
        ...
        do{
            ...
            if (e.getId() == chu.getId_marca()){
                cbxMarca.setSelectedIndex(id);
            }
            id++;
        }while(id < m.getSize());
        
        //Selecionar o tipo do solado
        /*DefaultComboBoxModel t = (DefaultComboBoxModel)cbxTipo.getModel();
        int id2 = 0;
        do{
            Chuteira e = (Chuteira)t.getElementAt(id2);
            if (e.getId() == chu.getId_tipo()){
                cbxTipo.setSelectedIndex(id2);
            }
            id2++;
        }while(id2 < m.getSize());
        */
    ...
    private void initComponents() {
        ...
        lblTipo.setText("Tipo do solado");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cbxTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(23, 23, 23)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        c.setId_marca(e.getId());
        
        /*Tipo h = (Tipo)cbxTipo.getSelectedItem();
        t.setId_tipo2(e.getId()); */
        
        int res = -1;
        if (txtId.getText().isEmpty()) {
            res = new ChuteiraDAO().inserir(c);
        }else{
            c.setId(Integer.parseInt(txtId.getText()));
            res = new ChuteiraDAO().atualizar(c);
        }
    ...
    private void configurarFormulario() {
        this.setTitle("CADASTRAR CHUTEIRA");
