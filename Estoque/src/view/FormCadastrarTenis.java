 ...
 * @author lucas
 */
public class FormCadastrarTenis extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormCadastrarTenis
     */
    public FormCadastrarTenis() {
        initComponents();
        configurarFormulario();
    }
    
    public FormCadastrarTenis(Tenis ten){
        this();
        txtId.setText(Integer.toString(ten.getId()));
        txtNome.setText(ten.getNome());
        txtQuantidade.setText(Integer.toString(ten.getQuantidade()));
        txtPreco.setText(Double.toString(ten.getPreco()));
        ...
        int id2 = 0;
        do{
            Tenis e = (Tenis)t.getElementAt(id2);
            if (e.getId() == ten.getId_tipo2()){
                cbxMarca.setSelectedIndex(id2);
            }
            id2++;
        }while(id2 < m.getSize()); */
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        t.setQuantidade(Integer.parseInt(txtQuantidade.getText()));
        t.setPreco(Double.parseDouble(txtPreco.getText()));
        
        Marca e = (Marca)cbxMarca.getSelectedItem();
        t.setId_marca(e.getId());
        ...
        int res = -1;
        if (txtId.getText().isEmpty()) {
            res = new TenisDAO().inserir(t);
        }else{
            t.setId(Integer.parseInt(txtId.getText()));
            res = new TenisDAO().atualizar(t);
        }
