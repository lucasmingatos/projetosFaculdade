...
public class FuncionariosDAO {
    ...
    public long salvar(Funcionarios cat){
        try{
    ...
    public long remover(Long id){
        try{
            ...
            Funcionarios cat = em.find(Funcionarios.class, id);
    ...
    public List<Funcionarios> listar(){
        try{
           Query q = em.createNamedQuery("Funcionarios.listar");
     ...
     public long contar(){
        try{
            Query q = em.createNamedQuery("Funcionarios.contar");
     ...
     public List<Funcionarios> pesquisarPorNome(String nome){
        try{
           Query q = em.createNamedQuery("Funcionarios.porNome");
     ...
     public List<Funcionarios> pesquisarPorId(int id){
        try{
           Query q = em.createNamedQuery("Funcionarios.porId");
