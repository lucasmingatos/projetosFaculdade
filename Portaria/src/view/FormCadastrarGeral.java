...
import model.Geral;
import static view.FormPrincipal.centralizarFormulario;

/**
 *
 * @author Alexandre
 */
public class FormCadastrarGeral extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormCadastrarGeral
     */
    public FormCadastrarGeral() {
        initComponents();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(scpDados, javax.swing.GroupLayout.DEFAULT_SIZE, 905, Short.MAX_VALUE)
    ...
    private void txtPesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisarKeyReleased
        try {
            List<Geral> resultado = null;
            if (rdbId.isSelected()) {
                resultado = new GeralDAO().pesquisarPorId(Integer.parseInt(txtId.getText()));
            } else if (rdbNome.isSelected()) {
                resultado = new GeralDAO().pesquisarPorNome(txtNome.getText());
            }
            listar(resultado);
        } catch (Exception e) {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (txtNome.getText().isEmpty() || txtFuncao.getText().isEmpty() || txtFuncao.getText().isEmpty() || txtStatus.getText().isEmpty()) {
            ...
            long res = new GeralDAO().salvar(cat);
            if (res > 0) {
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        if (txtId.getText().isEmpty()) {
            ...
            if (resp == JOptionPane.YES_OPTION) {
                new GeralDAO().remover(Long.parseLong(txtId.getText()));
                listar(new GeralDAO().listar());
            }
        }
    ...
    private void listar(List<Geral> lista) {
        if (lista != null) {
            configurarTabela();
